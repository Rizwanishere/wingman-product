        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@wingmanproduct.com" className="text-gray-600 hover:text-strata-purple">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-strata-darkPurple">Demo</h4>
                    <a href="mailto:demo@wingmanproduct.com" className="text-gray-600 hover:text-strata-purple">
            ...
            <div className="bg-strata-purple rounded-xl shadow-md p-8 text-white">
              ...
              <Button variant="outline" className="border-white bg-white text-strata-darkPurple hover:text-white w-full">
                Chat With Support
              </Button>
            </div>
          </motion.div>
