    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <AnimatedText delay={0.1} className="text-xl text-wingman-blue font-medium">
        ...
        <AnimatedSection delay={0.3} className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            The <span className="text-wingman-blue font-medium">typical identity service turnover</span> is at least five to eight years. A fabric turns that
